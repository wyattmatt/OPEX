<div class="navbar-glass navbar navbar-expand-lg px-0 px-lg-4">
  <div class="container-fluid px-lg-0">
    ...
    <ul class="list-unstyled d-flex align-items-center mb-0 gap-2">
      <!-- Pages link -->
      <li>
        <button type="button" id="scan-btn" class="btn btn-white" data-bs-toggle="modal" data-bs-target="#scannerModal">
          <span>
            <i style="font-size: 19px; vertical-align: middle;" class="ti theme-icon ti ti-qrcode"></i>
          </span>
        ...
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-0">
          <div>
            ...
            <div class="p-3 d-flex flex-column gap-1">
              <a href="{{ url('/') }}" class="dropdown-item d-flex align-items-center gap-2">
            ...
            <div class="border-dashed border-top mb-4 pt-4 px-6">
              <form method="POST" action="{{ route('logout') }}">
                @csrf
                <a href="#" onclick="event.preventDefault(); this.closest('form').submit();" class="text-secondary d-flex align-items-center gap-2">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                      stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
